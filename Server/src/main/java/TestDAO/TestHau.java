...
//	//	System.out.println(cdd);
		String maNV ="HC02201006";
		NhanVien nvv = nv.timKiemNhanVien(maNV);
         double luongCoBan = nvv.getLuongCoBan();
		DAO_PhieuChamCongNhanVien pcc = new DAO_PhieuChamCongNhanVien();
		//double a = pcc.getTongTienPhatTrongThang("SX0221017",4, 2024);
		//double b = pcc.getSoNgayLam("HC02201006",4, 2024);
		//int c = pcc.getTongGioTangCaTrongThang("HC02201006",4, 2024);
		double d =  pcc.getSoNgayLam(maNV, 4, 2024)*luongCoBan/24
        		-pcc.getTongTienPhatTrongThang(maNV, 4, 2024)
        		+pcc.getTongGioTangCaTrongThang(maNV, 4, 2024)*luongCoBan/(24*8)*1.5;
		//sSystem.out.print(a);
		//System.out.print(b);
		//System.out.print(c);
		System.out.print(d);
