...
public class GD_ChamCong extends javax.swing.JPanel {
	 ...
	 */
	IDAOPhieuChamCongCongNhan DAO_PCCCN;
...
//        DAO_BoPhan daoBoPhan = new DAO_BoPhan();
	...
	public void loadDataTabale1() throws RemoteException {
		DefaultTableModel model = (DefaultTableModel) jTable3.getModel();
		model.setRowCount(0);
		String tenBoPhan = jComboBox3.getSelectedItem().toString();

//		String maBoPhan = IDAOBoPhan.getMaBoPhanByTenBoPhan(tenBoPhan);
		String maBoPhan = daoBoPhan.getMaBoPhanByTenBoPhan(tenBoPhan);
		ArrayList<Object[]> dataChamCongCN = DAO_PCCCN.getDanhSachThongTinChamCongByIDBoPhan(maBoPhan);
	...
	public void loadDataTable2() {
		...
		String maBoPhan = "";
		try {
//			maBoPhan = IDAOBoPhan.getMaBoPhanByTenBoPhan(tenBoPhan);
			maBoPhan = daoBoPhan.getMaBoPhanByTenBoPhan(tenBoPhan);
		} catch (RemoteException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
//		ArrayList<Object[]> dataChamCongNV = DAO_PhieuChamCongNhanVien.getDanhSachThongTinChamCongByIDBoPhan(maBoPhan);
		ArrayList<Object[]> dataChamCongNV = null;
		try {
			dataChamCongNV = daoPhieuChamCongNhanVien.getDanhSachThongTinChamCongByIDBoPhan(maBoPhan);
		} catch (RemoteException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	...
	private void initComponents() {
		...
		jTable3.setModel(new javax.swing.table.DefaultTableModel(
				new Object[][] { { null, null, null, null, null, null, null, null, null, null },
						...
						{ null, null, null, null, null, null, null, null, null, null },
						{ null, null, null, null, null, null, null, null, null, null } },
				new String[] { "Mã công nhân", "Tên công nhân", "Vắng", "Công đoạn", "Số lượng giao", "Số lượng làm",
						"Số lượng tăng ca", "Tiền thưởng", "Tiền phạt", "Nội dung phạt" }) {
			...
			boolean[] canEdit = new boolean[] { false, false, true, false, false, true, true, true, true, true };
				...
				.setHorizontalGroup(
						jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addGroup(jPanel1Layout.createSequentialGroup().addContainerGap()
										.addComponent(jScrollPane3, javax.swing.GroupLayout.DEFAULT_SIZE, 882,
												Short.MAX_VALUE)
										.addContainerGap())
								.addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
										jPanel1Layout.createSequentialGroup()
												...
												.addGap(49, 49, 49))
								.addGroup(jPanel1Layout.createSequentialGroup().addGap(52, 52, 52).addComponent(jLabel6)
										.addGap(18, 18, 18)
										.addComponent(jComboBox3, javax.swing.GroupLayout.PREFERRED_SIZE, 154,
												javax.swing.GroupLayout.PREFERRED_SIZE)
										.addGap(108, 108, 108).addComponent(jLabel5).addGap(18, 18, 18)
		...
		jPanel1Layout
				.setVerticalGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(jPanel1Layout.createSequentialGroup().addGap(27, 27, 27).addGroup(jPanel1Layout
								...
								.addComponent(jButton5).addComponent(jTextField3,
										javax.swing.GroupLayout.PREFERRED_SIZE, 27,
										javax.swing.GroupLayout.PREFERRED_SIZE))
								.addGap(27, 27, 27)
								.addComponent(jScrollPane3, javax.swing.GroupLayout.PREFERRED_SIZE, 369,
										javax.swing.GroupLayout.PREFERRED_SIZE)
		...
		jTable2.setModel(new javax.swing.table.DefaultTableModel(
				new Object[][] { { null, null, null, null, null, null }, { null, null, null, null, null, null },
						...
						{ null, null, null, null, null, null }, { null, null, null, null, null, null },
						{ null, null, null, null, null, null }, { null, null, null, null, null, null } },
				new String[] { "Mã nhân viên", "Tên nhân viên", "Vắng", "Đi trễ", "Tiền phạt", "Nội dung phạt" }) {
			Class[] types = new Class[] { java.lang.String.class, java.lang.String.class, java.lang.Boolean.class,
				...
				.setHorizontalGroup(
						jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addGroup(jPanel2Layout.createSequentialGroup().addContainerGap()
										.addComponent(jScrollPane2, javax.swing.GroupLayout.DEFAULT_SIZE, 882,
												Short.MAX_VALUE)
										.addContainerGap())
								.addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
										jPanel2Layout.createSequentialGroup()
												.addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
												.addComponent(jButton2, javax.swing.GroupLayout.PREFERRED_SIZE, 148,
														javax.swing.GroupLayout.PREFERRED_SIZE)
												.addGap(49, 49, 49))
								.addGroup(jPanel2Layout.createSequentialGroup().addGap(52, 52, 52).addComponent(jLabel4)
										.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
										.addComponent(jComboBox2, javax.swing.GroupLayout.PREFERRED_SIZE, 154,
												javax.swing.GroupLayout.PREFERRED_SIZE)
										.addGap(120, 120, 120).addComponent(jLabel3)
										.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
		...
		jPanel2Layout
				.setVerticalGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(jPanel2Layout.createSequentialGroup().addGap(27, 27, 27).addGroup(jPanel2Layout
								...
								.addGap(32, 32, 32).addComponent(jButton2, javax.swing.GroupLayout.PREFERRED_SIZE, 34,
										javax.swing.GroupLayout.PREFERRED_SIZE)
								.addGap(16, 16, 16)));
		...
		jPanel3Layout.setHorizontalGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel3Layout.createSequentialGroup()
						.addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
						.addComponent(jLabel1, javax.swing.GroupLayout.PREFERRED_SIZE, 371,
								javax.swing.GroupLayout.PREFERRED_SIZE)
						.addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
				.addGroup(
						jPanel3Layout.createSequentialGroup().addContainerGap().addComponent(jLabel2).addGap(18, 18, 18)
		...
		jPanel3Layout.setVerticalGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel3Layout.createSequentialGroup()
						...
						.addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
										jPanel3Layout.createSequentialGroup().addComponent(jLabel1).addGap(28, 28, 28))
								.addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
	...
	private void jButton2MouseClicked(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_jButton2MouseClicked
		...
		try
		{
			...
			for (int i = 0; i < row; i++) {
				...
				phieuChamCongHanhChinh.setNhanVien(daoNhanVien.timKiemNhanVien((String) model.getValueAt(i, 0)));
	...
	private void ChamCongCongNhan()
	{
		try
		{
			...
			for (int i = 0; i < row; i++) {
				...
				double donGiaCongDoan = (double) daoCongDoan.get(maCD).getDonGia();		
				phieuChamCongCongNhan.setMaPCCCN("PCCCN" + maCTPC);
				phieuChamCongCongNhan.setChiTietPhanCong(daoChiTietPhanCong.get(maCTPC));
				...
				phieuChamCongCongNhan.setTienCong((int) (phieuChamCongCongNhan.getSoLuongSanPham()
						+ phieuChamCongCongNhan.getSoLuongSanPhamTangCa() * 1.2) * donGiaCongDoan);
				phieuChamCongCongNhan.setTienPhat((int) model.getValueAt(i, 8));
				phieuChamCongCongNhan.setTienThuong((int) (model.getValueAt(i, 7)));

				try {
					if (soCDGiao < phieuChamCongCongNhan.getSoLuongSanPham()
							+ phieuChamCongCongNhan.getSoLuongSanPhamTangCa()) {
...
//					int soLuongCDGiao = DAO_ChiTietPhanCong.getSoLuongCongDoanGiaoByMaCongNHan(maCN);
					int soLuongCDGiao = 0;
					try {
						soLuongCDGiao = daoChiTietPhanCong.getSoLuongCongDoanGiaoByMaCongNHan(maCN);
					} catch (Exception e) {
						// TODO Auto-generated catch block
						e.printStackTrace();
					}
			...
			if (value instanceof Boolean) {
				boolean isSelected = (Boolean) value;
				if (isSelected) {
					JOptionPane.showMessageDialog(this, "Công nhân đang vắng làm!", "Cảnh báo",
							JOptionPane.INFORMATION_MESSAGE);
	...
	private void jButton5MouseClicked(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_jButton5MouseClicked
		...
		if (maCN.isEmpty()) {
			JOptionPane.showMessageDialog(this, "Mã công nhân trống!", "Cảnh báo", JOptionPane.INFORMATION_MESSAGE);
			return;
		}
//		Object[] thongTinChamCong = DAO_PhieuChamCongCongNhan.getThongTinChamCongByMaCongNhan(maCN);
		Object[] thongTinChamCong = null;
		try {
			thongTinChamCong = daoPhieuChamCongCongNhan.getThongTinChamCongByMaCongNhan(maCN);
		} catch (RemoteException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
...
//		Object[] rowdata = DAO_PhieuChamCongNhanVien.gethongTinChamCongByMaNV(maNV);
		Object[] rowdata = null;
		try {
			rowdata = daoPhieuChamCongNhanVien.gethongTinChamCongByMaNV(maNV);
		} catch (RemoteException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
