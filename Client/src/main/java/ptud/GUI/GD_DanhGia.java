...
//		DAO_NhanVien daoNhanVien = DAO_NhanVien.getInstance();
		...
		for (int row = 0; row < model.getRowCount(); row++) {
			try {
				...
				if (kiemTraGiaTri(diemHieuSuat) && kiemTraGiaTri(diemChuyenMon) && kiemTraGiaTri(diemThaiDo)
						&& kiemTraGiaTri(diemChuyenCan)) {
					...
					JOptionPane.showMessageDialog(this, "Giá trị của các cột phải nằm trong khoảng từ 0 đến 10.",
							"Thông báo", JOptionPane.WARNING_MESSAGE);
					tableCN.changeSelection(row, 2, false, false);
					return;
				}
			} catch (NumberFormatException e) {
				JOptionPane.showMessageDialog(this, "Vui lòng nhập giá trị số cho các cột điểm.", "Lỗi",
...
//		DAO_BangDanhGiaNhanVien daoBangDanhGiaNhanVien = DAO_BangDanhGiaNhanVien.getInstance();
		...
		JOptionPane.showMessageDialog(this, "Xác nhận lưu trữ thành công", "Thông báo",
...
//		DAO_BangDanhGiaCongNhan daoBangDanhGiaCongNhan = DAO_BangDanhGiaCongNhan.getInstance();
	...
	private void initComponents() {
		...
		try {
			...
			daoBangDanhGiaCongNhan = (IDAOBangDanhGiaCongNhan) Naming.lookup(Client.URL + "DAOBangDanhGiaCongNhan");
			daoNhanVien = (IDAONhanVien) Naming.lookup(Client.URL + "DAONhanVien");
			daoBangDanhGiaNhanVien = (IDAOBangDanhGiaNhanVien) Naming.lookup(Client.URL + "DAOBangDanhGiaNhanVien");
		} catch (Exception e) {
		...
		headerLayout.setVerticalGroup(headerLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
						headerLayout.createSequentialGroup().addGap(0, 0, 0)
								.addComponent(jLabel1, javax.swing.GroupLayout.DEFAULT_SIZE, 61, Short.MAX_VALUE)
								.addGap(0, 0, 0).addComponent(jPanel1, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)));
		...
		tableCN.setModel(new javax.swing.table.DefaultTableModel(
				new Object[][] { { "1", "1", null, null, null, null, null, null },
						...
						{ null, null, null, null, null, null, null, null },
						{ null, null, null, null, null, null, null, null } },
				new String[] { "Mã CN", "Tên công nhân", "Điểm hiệu suất", "Điểm chuyên môn", "Điểm thái độ",
						"Điểm chuyên cần", "Tổng điểm", "Xếp loại" }) {
			Class[] types = new Class[] { java.lang.String.class, java.lang.String.class, java.lang.String.class,
					java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.String.class,
					java.lang.String.class };
			boolean[] canEdit = new boolean[] { false, false, true, true, true, true, false, false
		...
		optionLayout.setHorizontalGroup(optionLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
						optionLayout.createSequentialGroup().addGap(30, 30, 30)
								.addComponent(txtYearCN, javax.swing.GroupLayout.PREFERRED_SIZE, 127,
										javax.swing.GroupLayout.PREFERRED_SIZE)
								.addGap(18, 18, 18)
								.addComponent(btnDanhGiaCN, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
								.addGap(18, 18, 18)
								.addComponent(btnXacNhanCN, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
								.addGap(18, 18, 18)
								.addComponent(btnSearchCN, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
								.addGap(0, 0, 0).addComponent(txtSearchCN, javax.swing.GroupLayout.PREFERRED_SIZE, 268,
										javax.swing.GroupLayout.PREFERRED_SIZE)
								.addContainerGap(265, Short.MAX_VALUE)));
		optionLayout.setVerticalGroup(optionLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(javax.swing.GroupLayout.Alignment.TRAILING, optionLayout.createSequentialGroup()
						...
						.addGroup(optionLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addComponent(txtYearCN, javax.swing.GroupLayout.PREFERRED_SIZE, 30,
										javax.swing.GroupLayout.PREFERRED_SIZE)
								.addComponent(btnSearchCN, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
								.addGroup(optionLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
										.addComponent(txtSearchCN, javax.swing.GroupLayout.PREFERRED_SIZE,
		...
		contentCNLayout.setHorizontalGroup(contentCNLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(scrollTableCN)
				.addComponent(option, javax.swing.GroupLayout.DEFAULT_SIZE, 1074, Short.MAX_VALUE)

		);
		contentCNLayout.setVerticalGroup(contentCNLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
		...
		tableNV.setModel(new javax.swing.table.DefaultTableModel(
				new Object[][] { { null, null, null, null, null, null, null, null },
						...
						{ null, null, null, null, null, null, null, null },
						{ null, null, null, null, null, null, null, null } },
				new String[] { "Mã NV", "Tên nhân viên", "Điểm hiệu suất", "Điểm chuyên môn", "Điểm thái độ",
						"Điểm chuyên cần", "Tổng điểm", "Xếp loại" }) {
			Class[] types = new Class[] { java.lang.String.class, java.lang.String.class, java.lang.String.class,
					java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.String.class,
					java.lang.String.class };
		...
		searchCriteriaNV
				.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Mã CN", "Tên nhân viên", " ", " " }));
		...
		optionNVLayout.setHorizontalGroup(optionNVLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
						optionNVLayout.createSequentialGroup().addGap(30, 30, 30)
								.addComponent(txtYearNV, javax.swing.GroupLayout.PREFERRED_SIZE, 127,
										javax.swing.GroupLayout.PREFERRED_SIZE)
								.addGap(18, 18, 18)
								.addComponent(btnDanhGiaNV, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
								.addGap(18, 18, 18)
								.addComponent(btnXacNhanNV, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
								.addGap(18, 18, 18)
								.addComponent(btnSearchNV, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
								.addGap(0, 0, 0)
								.addComponent(txtSearchNV, javax.swing.GroupLayout.PREFERRED_SIZE, 268,
										javax.swing.GroupLayout.PREFERRED_SIZE)
								.addGap(114, 114, 114)
								.addComponent(searchCriteriaNV, javax.swing.GroupLayout.PREFERRED_SIZE, 110,
										javax.swing.GroupLayout.PREFERRED_SIZE)
								.addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
		optionNVLayout.setVerticalGroup(optionNVLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(javax.swing.GroupLayout.Alignment.TRAILING, optionNVLayout.createSequentialGroup()
						...
						.addGroup(optionNVLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
								.addComponent(txtYearNV, javax.swing.GroupLayout.PREFERRED_SIZE, 30,
										javax.swing.GroupLayout.PREFERRED_SIZE)
								.addGroup(optionNVLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
										.addGroup(optionNVLayout
												.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
												.addComponent(searchCriteriaNV, javax.swing.GroupLayout.PREFERRED_SIZE,
														30, javax.swing.GroupLayout.PREFERRED_SIZE)
												.addComponent(txtSearchNV, javax.swing.GroupLayout.PREFERRED_SIZE,
														javax.swing.GroupLayout.DEFAULT_SIZE,
														javax.swing.GroupLayout.PREFERRED_SIZE))
										.addGroup(optionNVLayout
												...
												.addComponent(btnSearchNV, javax.swing.GroupLayout.PREFERRED_SIZE,
														javax.swing.GroupLayout.DEFAULT_SIZE,
														javax.swing.GroupLayout.PREFERRED_SIZE)
												.addGroup(javax.swing.GroupLayout.Alignment.LEADING, optionNVLayout
														.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
														.addComponent(btnXacNhanNV,
																javax.swing.GroupLayout.PREFERRED_SIZE,
																javax.swing.GroupLayout.DEFAULT_SIZE,
																javax.swing.GroupLayout.PREFERRED_SIZE)
														.addComponent(btnDanhGiaNV,
																javax.swing.GroupLayout.PREFERRED_SIZE,
																javax.swing.GroupLayout.DEFAULT_SIZE,
																javax.swing.GroupLayout.PREFERRED_SIZE)))))
						.addGap(17, 17, 17)));
		...
		contentNVLayout.setHorizontalGroup(contentNVLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(scrollTableNV)
				.addGroup(contentNVLayout.createSequentialGroup()
						.addComponent(optionNV, javax.swing.GroupLayout.PREFERRED_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
						.addGap(0, 190, Short.MAX_VALUE)));
		contentNVLayout.setVerticalGroup(contentNVLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(contentNVLayout.createSequentialGroup().addGap(0, 0, 0)
						.addComponent(optionNV, javax.swing.GroupLayout.PREFERRED_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
						.addGap(0, 0, 0)
