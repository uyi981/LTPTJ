...
public class GD_QLHD extends javax.swing.JPanel {
	...
	IDAOHopDong daoHongDong;
	IDAOKhachHang daoKhachHang;
	...
	public GD_QLHD() throws Exception {
		initComponents();
		daoHongDong = (IDAOHopDong) Naming.lookup(Client.URL + "DAOHopDong");
		daoKhachHang = (IDAOKhachHang) Naming.lookup(Client.URL + "DAOKhachHang");
	...
	void fillHopDongTable() throws RemoteException {
		for (HopDong hopDong : daoHongDong.layDanhSachHopDong()) {
			changeEnityHD(hopDong);
		}
	}

	void fillKhachHangTable() throws RemoteException {
		for (KhachHang khachHang : daoKhachHang.LayDanhSachKhachHang()) {
	...
	private void initComponents() throws RemoteException {
		...
		heading_2Layout
				.setHorizontalGroup(heading_2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(heading_2Layout.createSequentialGroup().addContainerGap()
								.addComponent(taoHopDongButton).addGap(79, 79, 79).addComponent(jLabel1)
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
								.addComponent(jTextField1, javax.swing.GroupLayout.PREFERRED_SIZE, 405,
										javax.swing.GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
								.addComponent(timButton, javax.swing.GroupLayout.PREFERRED_SIZE, 22,
										javax.swing.GroupLayout.PREFERRED_SIZE)
								.addGap(35, 35, 35).addComponent(jLabel2).addGap(18, 18, 18)
								.addComponent(jComboBox1, javax.swing.GroupLayout.PREFERRED_SIZE, 136,
										javax.swing.GroupLayout.PREFERRED_SIZE)
								.addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
		heading_2Layout.setVerticalGroup(heading_2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(heading_2Layout.createSequentialGroup().addGroup(heading_2Layout
						.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(taoHopDongButton)
						.addComponent(jTextField1, javax.swing.GroupLayout.PREFERRED_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
						.addComponent(jLabel1)
						.addComponent(timButton, javax.swing.GroupLayout.PREFERRED_SIZE, 23,
								javax.swing.GroupLayout.PREFERRED_SIZE)
						.addComponent(jLabel2).addComponent(jComboBox1)).addContainerGap(27, Short.MAX_VALUE)));
		...
		heading_1Layout
				.setHorizontalGroup(heading_1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(heading_1Layout.createSequentialGroup().addContainerGap()
								.addComponent(jLabel3, javax.swing.GroupLayout.DEFAULT_SIZE, 952, Short.MAX_VALUE)
								.addContainerGap()));
		heading_1Layout.setVerticalGroup(heading_1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
		...
		hopDongTable.setModel(new javax.swing.table.DefaultTableModel(new Object[][] {

		}, new String[] { "Mã hợp đồng", "Tên hợp đồng", "Ngày bắt đầu", "Ngày kết thúc", "Trị giá hợp đồng",
				"Trạng thái" }) {
		...
		hopDong_PanelLayout
				.setHorizontalGroup(hopDong_PanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(hopDong_PanelLayout.createSequentialGroup().addContainerGap()
								.addComponent(hopDongScroll, javax.swing.GroupLayout.DEFAULT_SIZE, 952, Short.MAX_VALUE)
								.addContainerGap()));
		hopDong_PanelLayout.setVerticalGroup(
				hopDong_PanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(
						javax.swing.GroupLayout.Alignment.TRAILING,
						hopDong_PanelLayout.createSequentialGroup().addContainerGap()
		...
		khachHangTable.setModel(new javax.swing.table.DefaultTableModel(
				...
				new String[] { "Mã Khách Hàng", "Tên Khách hàng", "email", "số điện thoại", "Tổ chức" }) {
		...
		khachHang_PanelLayout
				.setHorizontalGroup(khachHang_PanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addComponent(khachHangScroll, javax.swing.GroupLayout.DEFAULT_SIZE, 964, Short.MAX_VALUE));
		khachHang_PanelLayout.setVerticalGroup(khachHang_PanelLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(khachHang_PanelLayout.createSequentialGroup().addContainerGap()
		...
		body_1Layout.setHorizontalGroup(
				body_1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(jTabbedPane1));
		...
		layout.setHorizontalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
						.addComponent(body, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
								Short.MAX_VALUE)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(rightSide,
								javax.swing.GroupLayout.PREFERRED_SIZE, 490, javax.swing.GroupLayout.PREFERRED_SIZE)));
		layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addComponent(rightSide, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
						Short.MAX_VALUE)
				.addComponent(body, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
						Short.MAX_VALUE));
		...
		try {
			if (jTabbedPane1.getSelectedIndex() == 0) {
				if (jComboBox1.getSelectedIndex() == 0) {
					...
					if (daoHongDong.timKiemHopDong(id) == null) {
						JOptionPane.showMessageDialog(this, "Không tìm thấy hợp đồng!");
					} else {
						deleleTable(hopDongModel);
						changeEnityHD(daoHongDong.timKiemHopDong(id));
					}
				...
				if (jComboBox1.getSelectedIndex() == 0) {
					String id = jTextField1.getText();
					if (daoKhachHang.timKiemKhachHang(id) == null) {
						JOptionPane.showMessageDialog(this, "Không tìm thấy khách hàng!");
					} else {
						deleleTable(khacHangModel);
						changeEnityKH(daoKhachHang.timKiemKhachHang(id));
					}
				} else if (jTextField1.getText().equals("")) {
					updateTable();
				} else {
